  ...
  return (
    <div className="xl:max-w-layout md:max-w-5xl mx-auto mt-5 mb-10 px-2 ">
      <div className="flex flex-col lg:flex-row justify-between items-center">
        <div className="flex flex-col justify-center gap-3 w-[300px] h-[500px] pt-4">
          <img src="/elearning/card1.png" alt="card" />
          <p className="text-2xl font-semibold leading-9 -mt-3">
        ...
        <div className="flex flex-col justify-center gap-3 w-[300px] h-[500px]">
          <img src="/elearning/card2.png" alt="card" className="" />
          <p className="text-2xl font-semibold leading-9 mt-2">
