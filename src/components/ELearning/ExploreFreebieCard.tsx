  ...
  return (
    ...
    <CardBody>
      ...
      <Typography color="red">
       <span className="text-lg">Dr.Angela Du</span>  <span className="text-sm text-black">(from Udemy)</span>
      </Typography>
      <div className="group mt-8 inline-flex flex-wrap items-center gap-3">
      <span className="text-xl text-black">$00</span> <span className="line-through">100</span> <span className="text-sm">11.5 total hours,All Level</span>
