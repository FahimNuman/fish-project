    ...
    return (
        <div className="xl:max-w-inner md:max-w-5xl mx-auto mt-12 mb-16 px-2">
            <div className="grid md:grid-cols-2 grid-cols-1">
                {/* Image on the left */}
                <div className="col-span-1 xl:w-[650px] w-[250px] xl:h-[650px] h-[350px] mt-10 md:mt-0 mb-4 md:mb-0"> {/* Add mb-4 for margin below the image */}
                    <img src="/enroll/cou[pon.png" alt="person" />
                </div>

                {/* Text on the right */}
                <div className="col-span-1 flex flex-col gap-9 justify-center ml-4 mt-4 md:mt-0"> {/* Add mt-4 for margin above the text */}
                    <h2 className="text-2xl md:text-4xl flex items-end gap-2">

                        <span className="">Enroll any course
                        </span>
                    </h2>
