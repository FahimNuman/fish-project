    ...
    <div className="my-30 mb-52 max-w-inner md:max-w-6xl overflow-hidden px-2 mx-auto">
      <div className="max-w-inner mx-auto flex flex-col items-center">
        <h2
          ...
          className="text-2xl md:text-5xl font-semibold my-10 "
        >
          Hello How Can
          <span
            style={{ fontFamily: "Conthrax-SB" }}
        ...
        <p
          style={{ fontFamily: "Conthrax-SB" }}
          className="text-[16px] md:text-[24px] pt-[47px]"
        >
          or
        </p>
        <br />
        <span style={{ fontFamily: "Conthrax-SB" }}>
          {" "}
        ...
        {helpCardItem.map((item) => (
          <div
            ...
            className={`col-span-1 ${
              activeHelpCard === item.id &&
              " border-red-400 border hover:text-blue-500"
            }`}
